...
<h1 class="txt-preto">Pudding</h1>
<img src="Images/pudimd.png" alt="10" width="75" style="margin-top: 5px;">
</div>
  <div class="nav-bar">
    <div class="">
...
<div class="modal fade" id="modalColetivo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Importacao</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
      ...
      <div class="modal-body">
        ...
        <input type="hidden" id="editGarantia" class="form-control">
          ...
          <div class="mb-3">
            ...
            <select class="form-select" id="exampleSelect" name="editModelo" >
              <option value="One">One</option>
              <option value="Two">Two</option>
              <option value="Three">Three</option>
            </select>
