    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="addMarca">
          ...
          <button type="submit" class="btn btn-primary" value="cadastrar" onclick="criarMarca()">Enviar</button>
        </form>
      </div>
    </div>
  </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="addProblema">
          ...
          <button type="submit" class="btn btn-primary" value="cadastrar" onclick="">Enviar</button>
        </form>
      </div>
    </div>
  </div>
